...
class ButtonClass extends React.Component
{
    ...
    {
        return(
            <button type="button" id={this.state.id} className="btn btn-success mx-1 my-sm-0" >{this.state.heading}</button>
        );
    }
}
...
const buttons = [{id:"saveDrawingButton", heading:"Predict"},
                 {id:"eraseButton", heading:"Erase All"},
...
// Rendering all function buttons
ReactDOM.render(
...
// color and function buttons after they are loaded
// by react in the DOM
